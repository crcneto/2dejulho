            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="<?= site_url('home/quem_somos')?>">Quem somos</a></li>
                        <li><a href="<?= site_url('home/contato')?>">Contato</a></li>
                        <li><a href="<?= site_url('home/localizacao')?>">Localização</a></li>
                        <!--li><a href="#">Link</a></li-->
                    ...
                    <?php } ?>
                    <p class="navbar-text navbar-right"><a href="https://p3plcpnl1009.prod.phx3.secureserver.net:2096/logout/?locale=pt_br" target=“_blank”><i class="glyphicon glyphicon-envelope" title="Acessar e-mail" data-toggle="tooltip" data-placement="bottom"></i></a></p>
                </div><!-- /.navbar-collapse -->
            </div><!-- /.container-fluid -->
        </nav>
        <div class="row">
